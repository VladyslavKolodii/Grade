...
class AddLocationPhotoVC: UIViewController {
...
extension AddLocationPhotoVC: AVCaptureVideoDataOutputSampleBufferDelegate {
    func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        ...
        DispatchQueue.main.async {
            self.performSegue(withIdentifier: "photoPreview", sender: uiImage)
